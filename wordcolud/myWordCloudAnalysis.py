...
# 설치한 matplotlib 외부라이브러의 pyplot 기능을 사용하며, pyplot 기능을 약어로 plt로 정의
...
text = "한국폴리텍대학 서울강서캠퍼스(학장 노정진)는 데이터분석과 2학년 김한결, 황윤영, 홍두표 학생과 1학년 김도우 학생이 " \
...
# 명사 분석 결과는 여러 단어들이 저장된 배열혈태로 데이터를 생성하기 때문에 배열을 문자열로 변경하기위해
