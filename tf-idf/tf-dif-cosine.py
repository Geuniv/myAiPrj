...
# 문서1과 문서2의 유사도 분석
print("문서1과 문서2의 유사도 : " + str(cos_sin(result[0], result[1])))

# 문서1과 문서3의 유사도 분석
print("문서1과 문서3의 유사도 : " + str(cos_sin(result[0], result[2])))

# 문서1과 문서4의 유사도 분석
print("문서1과 문서4의 유사도 : " + str(cos_sin(result[0], result[3])))

# 문서1과 문서5의 유사도 분석
print("문서1과 문서5의 유사도 : " + str(cos_sin(result[0], result[4])))

# 문서1과 문서6의 유사도 분석
print("문서1과 문서6의 유사도 : " + str(cos_sin(result[0], result[5])))
...
for i in range(N) : # 각 문서에 대해서 아래 명령을 수행
    ...
    if doc_number != 1 :
        # 코사인 유사도 결과값
        cos_res = cos_sin(result[0], result[i])
...
# dic 데이터의 value를 값에 큰 순서에 따라 정렬하기
