...
train_ds = tf.keras.preprocessing.image_dataset_from_directory(
    ...
    seed=123, # 학습할 때, 이미지 배열을 랜덤하게 위치 변화시킬수
...
# label_batch는 (128,) 모양의 텐서이며 128 개의 이미지에 해당하는 레이블(즉, 정답)
...
####################################################################
# 6. 학습모델 파일 생성(학습모델 파일은 크게 SaveeModel과 HDF5 포맷이 존재함)
# 파일 확장자 없는 파일 : SaveModel 포맷 - Tensorflow 2.x 기본 학습모델
